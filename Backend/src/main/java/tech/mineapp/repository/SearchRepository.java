...
public interface SearchRepository extends JpaRepository<SearchEntity, Long> {
    Optional<SearchEntity> findSearchEntityByUserAndCategoryAndQuery(UserEntity userEntity, Category category, String query);
    ...
    Optional<List<SearchEntity>> findSearchEntitiesByCategoryOrderByNumOfSearchesDesc(Category category);
}
