    ...
    <body className="dashboard">
        <div class="row">
            <div class="col" id="searchclass">
                ...
                <input id="searchbar"class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search"></input>
                </form>
            </div>
            <div class="col-md-auto" id="searchclass">
                <div class="dropdown">
                <button id="categoriesdrop"class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    Categories
                </button>
